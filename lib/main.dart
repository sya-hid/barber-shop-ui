...
import 'package:barber_app_ui/pages/main_page.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => ServicesProvider()),
        BlocProvider(create: (context) => PriceProvider()),
        BlocProvider(create: (context) => GenderProvider()),
        BlocProvider(create: (context) => PriceProvider()),
        BlocProvider(create: (context) => BarbersProvider()),
        BlocProvider(create: (context) => MinRateProvider()),
        BlocProvider(create: (context) => SortByProvider())
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
